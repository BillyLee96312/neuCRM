...
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Raleway">
					  ...
					  <div class="row">
						   ...
						   <p class="text-center">
							...
							<logic:notEmpty name="ListUserForm" property="intPagingList">
								    
								    	<logic:iterate name="ListUserForm" id="PagingList" property="intPagingList" indexId="index">
									
								        
								            
								            <html:link page="/UserAction.do?actionMethod=List" paramId="pagingId"  
